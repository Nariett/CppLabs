...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->chart1->Location = System::Drawing::Point(282, 12);
			this->chart1->Name = L"chart1";
			series1->ChartArea = L"ChartArea1";
			series1->Legend = L"Legend1";
			series1->Name = L"Series1";
			this->chart1->Series->Add(series1);
			this->chart1->Size = System::Drawing::Size(299, 237);
			...
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(106, 73);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(106, 13);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(106, 42);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		{
				MessageBox::Show(this, "Null link.", "Error", MessageBoxButtons::OK,MessageBoxIcon::Error);
		}
		catch (System::FormatException^ e)
		{
			MessageBox::Show(this, "Enter a real number.", "Error",
				MessageBoxButtons::OK, MessageBoxIcon::Warning);
		}
		catch (System::OverflowException^ e)
		{
			MessageBox::Show(this, "Please enter a valid number.", "Number too large or too small", MessageBoxButtons::OK, MessageBoxIcon::Stop);
		}
	}
